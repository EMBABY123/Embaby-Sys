...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['!help','Type اشترك بقناه امبابي هيرو'];
    var i = -1;
    var j = 0;
...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
${prefix}كل البوتات/لعرض جميع البوتات الي بالسيرفر
${prefix}سيرفر/يعرض لك معلومات عن السيرفر
${prefix}بوت/يعرض لك كل معلومات البوت
${prefix}عددالاشخاص/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات
${prefix}الدعوات/ يعرض لك  عدد انفايتاتك بالسيرفر 
${prefix}معلومات الدعوه <invitelink here> / لمعلومات عن الدعوه
 مثال : invinfo m82n8P
${prefix}روابط الدعوات/يعرض لك روابط الانفايتات حكك في السيرفر 
${prefix}cal/اله حاسبة
${prefix}ترجمه <language> <any thing>/يترجم لك الي تبيه من اي لغة
${prefix}اختصار/يختصر لك رابط كبير الى رابط صغير
...
${prefix}زخرف/يزخرف لك كلمة او جملة
${prefix}الرومات/يعرض لك كل الرومات الي بالسيرفر مع عددها
${prefix}الرولات/يعرض لك كل الرانكات بالسيرفر بشكل جميل
${prefix}ايموجي/يعرض لك كل الايموجيات الي بالسيرفر
${prefix}تكرار/يكرر الكلام الي تكتبو
${prefix}صور/صورة السيرفر
${prefix}الاعضاء/عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
${prefix}معلومات/معلومات عنك
${prefix}المتبندين / عدد الاشخاص المبندة 
${prefix}صورتك/صورتك او صورة الي تمنشنو
${prefix}تكرار /يكرر الي تقولو بشكل حلو
${prefix}emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي
${prefix}دعوه البوت/لدعوة البوت الى سيرفرك
${prefix}الدعم/سيرفر الدعم
${prefix}اتصال/ارسال اقتراح او لمراسلة صاحب البوت
**
  `
,`
